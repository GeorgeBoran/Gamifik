...
loginAlumno(datosUsuario:alumno) {
  return this.http.get(`${this.URL}seleccionardatosAlumno.php?nickname=${datosUsuario["username"]}?password=${datosUsuario["password"]}`);
}

loginProfesor(datosUsuario:profe) {
  return this.http.get(`${this.URL}seleccionardatosProfesor.php?nickname=${datosUsuario["username"]}?password=${datosUsuario["password"]}`);
}

registerAlumno(registrarUsuario:alumno) {
  return this.http.get(`${this.URL}registrarAlumno.php?email=${registrarUsuario["mail"]}
